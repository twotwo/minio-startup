...
$ docker service ls
...
$ for i in $(seq 1 4); do docker service ps minio_stack_minio$i; done
...
```
...
```shell
$ mc alias set distrib http://10.0.50.250:9001 dev tuixiang2017 # mc admin user add distrib dev tuixiang2017
$ mc ls distrib/dicoms/v6_datas
[2022-05-05 11:51:54 CST]     0B ct_cerebral/
...
...
```shell
$ docker network inspect minio_stack_minio_distributed
...
        "IPAM": {
            "Driver": "default",
            "Options": null,
...
- [MinIO Console](https://docs.min.io/minio/baremetal/console/minio-console.html) `MINIO_BROWSER_REDIRECT_URL`